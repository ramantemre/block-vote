        ...
        <ul className="space-y-2">
          ...
          <li>
            ...
            >
              ...
              <span className="inline-flex h-5 w-5 items-center justify-center rounded-full bg-primary-100 text-xs font-semibold text-primary-800 dark:bg-primary-200 dark:text-primary-800">
                6
              </span>
            </a>
          </li>
                ...
                <g id="c">
                  <g id="e">
                    <g id="b">
                      ...
                      <use xmlnsXlink="#a" y="840" />
                      <use xmlnsXlink="#a" y="1260" />
                    </g>
                    <use xmlnsXlink="#a" y="1680" />
                  </g>
                  <use xmlnsXlink="#b" x="247" y="210" />
                </g>
                <use xmlnsXlink="#c" x="494" />
              </g>
              <use xmlnsXlink="#d" x="988" />
              <use xmlnsXlink="#c" x="1976" />
              <use xmlnsXlink="#e" x="2470" />
            </g>
          </svg>
        </button>
        {/* <!-- Dropdown --> */}
